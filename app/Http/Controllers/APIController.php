...
class APIController extends Controller
{
	...
	public function addsp(Request $request)
    {
        ...
        $sp->description = $request->input('description'); // Corrected field name
        $sp->unit_price = intval($request->input('unit_price')); // Corrected field name
        $sp->save();
        return response()->json($sp);
    }
    //
